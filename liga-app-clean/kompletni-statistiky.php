...
SELECT
  ...
  (
    SUM(CASE WHEN z.hrac1_id = u.libovolne_id THEN COALESCE(z.count_100p_home,0)
             WHEN z.hrac2_id = u.libovolne_id THEN COALESCE(z.count_100p_away,0)
             ELSE 0 END) * 1
    +
    SUM(CASE WHEN z.hrac1_id = u.libovolne_id THEN COALESCE(z.count_140p_home,0)
             WHEN z.hrac2_id = u.libovolne_id THEN COALESCE(z.count_140p_away,0)
             ELSE 0 END) * 2
    +
    SUM(CASE WHEN z.hrac1_id = u.libovolne_id THEN COALESCE(z.count_160p_home,0)
             WHEN z.hrac2_id = u.libovolne_id THEN COALESCE(z.count_160p_away,0)
             ELSE 0 END) * 3
    +
    SUM(CASE WHEN z.hrac1_id = u.libovolne_id THEN COALESCE(z.count_180_home,0)
