...
<title><?= htmlspecialchars($season['nazev']) ?> – správa</title><link rel="stylesheet" href="/liga-app/assets/admin.css?v=1"></head>
<body class="admin-body"><main class="admin-shell">
  ...
  <div class="admin-actions" style="margin-bottom:14px"><a class="admin-btn" href="/liga-app/admin/rozpis_sezony.php?rocnik_id=<?= $seasonId ?>">Kontrola a rozpis</a><a class="admin-btn admin-btn--secondary" href="/liga-app/admin/ligy_nazvy.php?rocnik_id=<?= $seasonId ?>">Názvy lig</a></div>
