...
$canOpenAdminPortal = in_array(($_SESSION['role'] ?? ''), ['admin', 'stat_editor'], true);
...
?>
  ...
  <div class="nk-mm-box">
    ...
    <div class="nk-mm-stack">
      ...
      <?php if ($canOpenAdminPortal): ?><a class="nk-mm-item" href="<?= htmlspecialchars($BASE_URL) ?>/admin/index.php">Admin</a><?php endif; ?>
