...
CREATE TABLE IF NOT EXISTS turnaj_registrace (
    ...
    CONSTRAINT fk_turnaj_registrace_turnaj
        FOREIGN KEY (turnaj_id) REFERENCES registracni_turnaje (id)
        ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_czech_ci;
...
CREATE TABLE IF NOT EXISTS turnaj_form_pole (
    ...
    CONSTRAINT fk_turnaj_form_pole_turnaj
        FOREIGN KEY (turnaj_id) REFERENCES registracni_turnaje (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_czech_ci;
...
CREATE TABLE IF NOT EXISTS turnaj_registrace_hodnoty (
    ...
    CONSTRAINT fk_turnaj_registrace_hodnoty_registrace
        FOREIGN KEY (registrace_id) REFERENCES turnaj_registrace (id) ON DELETE CASCADE,
    CONSTRAINT fk_turnaj_registrace_hodnoty_pole
        FOREIGN KEY (pole_id) REFERENCES turnaj_form_pole (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_czech_ci;
